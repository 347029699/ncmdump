...
print("------")
print("请在下方输入网易云音乐下载路径或存放ncm文件的路径，请确保输入正确，否则无法正常转换。")
print("路径可通过在网易云客户端中点击：设置 --> 下载设置，查看下载路径。")
print("如留空，默认: C:\\CloudMusic\\Download")

while True:
    download_folder = input("下载路径：")
    if os.path.exists(download_folder) and "\\" in download_folder:
        break
    else:
        print("输入路径有误!")
os.system('cls')
